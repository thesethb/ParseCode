...
while z < len(members):
    ...
    while n < len(icpsr):
        ...
        rep_avg = 0
        rep_avg1 = 0
        while n < len(partylist[0]) and billnum[n] == num:
    ...
    w = open('bill_list_go.csv', 'a')
    for bill in billlist:
        n = 0
        while n < len(billnum1):
            if bill[0] == billnum1[n]:
                print(str(106 + z) + str(bill[0]) + ', ' + str(bill[1]) + ', ' + str(bill[2]) + ', ' + str(bill[3]) + ', '+ str(info[0][n]) + ', ' +  str(info[1][n]) + ', ' +  str(info[2][n]) + ', ' +  str(info[3][n]) + ', ' +  str(info[4][n]))
                s = str(106 + z) + str(bill[0]) + ', ' + str(bill[1]) + ', ' + str(bill[2]) + ', ' + str(bill[3]) + ', '+ str(info[0][n]) + ', ' +  str(info[1][n]) + ', ' +  str(info[2][n]) + ', ' +  str(info[3][n]) + ', ' +  str(info[4][n]) + '\n'
                w.write(s)
            n += 1
    z += 1